----------------------------------------------------------------------------
-- MCP300x.vhd - Módulo de control del convertidor analógico-digital MCP300x
----------------------------------------------------------------------------
--
-- Este módulo implementa la comunicación SPI con el convertidor analógico-digital
-- MCP3004. Se encarga de iniciar conversiones, seleccionar canales y leer
-- los datos convertidos. Es esencial para la lectura de datos del sensor de pulso.
--
-- Puertos del módulo:
--
--      clk_i      -  Reloj del sistema
--      rst_i      -  Reset del sistema
--      start_i    -  Inicia una nueva conversión
--      busy_o     -  Indica si está en proceso de conversión
--      chn_i      -  Selecciona el canal del ADC
--      single_i   -  Modo single-ended o diferencial
--      ena_i      -  Habilita el reloj SPI
--      eoc_o      -  Indica el fin de una conversión
--      data_o     -  Valor digital convertido
--      ad_ncs_o   -  Señal de selección del esclavo SPI
--      ad_clk_o   -  Reloj SPI
--      ad_din_o   -  Línea de datos MOSI del SPI
--      ad_dout_i  -  Línea de datos MISO del SPI
--
------------------------------------------------------------------------------
----                                                                      ----
